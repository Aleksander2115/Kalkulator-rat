...
getRouter()->setDefaultRoute('resultList'); // akcja/ścieżka domyślna
getRouter()->setLoginRoute('login'); // akcja/ścieżka na potrzeby logowania (przekierowanie, gdy nie ma dostępu)

getRouter()->addRoute('calcShow',    'CalcCtrl',  ['user','admin']);
getRouter()->addRoute('calcCompute', 'CalcCtrl',  ['user','admin']);
getRouter()->addRoute('resultList',      'ResultListCtrl');
getRouter()->addRoute('resultSave',      'ResultListCtrl', ['user','admin']);
getRouter()->addRoute('resultDelete',      'ResultListCtrl', ['admin']);
